...
- Timed out with `R2G astrolabe spinning...` then `Error: The operation was canceled.` or `"TimeoutError: waiting for selector .loading-astrolabe to be hidden failed: timeout 600000ms exceeded"` 
